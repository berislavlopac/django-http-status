"""
Defines classes for the unofficial HTTP Response codes, usually defined by other RFCs or as proprietary extenxions.
Based on (and the docstrings taken from) the list at http://en.wikipedia.org/wiki/List_of_HTTP_status_codes -- Nginx internal codes, as well as a few others, were not included.
"""
